...
<link rel="stylesheet" href="{{ URL::asset('assets/admin/css/vendor/animsition.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('assets/admin/js/vendor/datetimepicker/css/bootstrap-datetimepicker.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('assets/admin/js/vendor/chosen/chosen.css') }}">
<link rel="stylesheet" href="{{ URL::asset('assets/admin/css/main.css') }}">
<link rel="stylesheet" href="{{ URL::asset('assets/admin/js/vendor/footable/css/footable.core.min.css') }}">
...
<!-- Vendor JavaScripts  -->
<script src="{{ URL::asset('assets/admin/bundles/libscripts.bundle.js') }}"></script>

<script src="{{ URL::asset('assets/admin/bundles/vendorscripts.bundle.js') }}"></script>

<script src="{{ URL::asset('assets/admin/js/vendor/chosen/chosen.jquery.min.js') }}"></script> 
<script src="{{ URL::asset('assets/admin/js/vendor/parsley/parsley.min.js') }}"></script>  
<script src="{{ URL::asset('assets/admin/js/vendor/footable/footable.all.min.js') }}"></script> 
